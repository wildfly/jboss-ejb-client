 ...
 */
public class LastNodeToLeaveTestCase extends AbstractEJBClientTestCase {
    ...
    public static List<Boolean> getServersStarted() {
        ...
        for (int i = 0; i < NUM_SERVERS; i++) {
            booleanList.add(new Boolean(isServerStarted(i)));
        }
        return booleanList;
    }
    ...
    public void testClusteredSLSBInvocation() throws Exception {
        ...
        undeployStateless(1);
        stopServer(0);
        removeClusterNodes(0, CLUSTER_REMOVE_NODE1);
        // adjust the view of the remaining server
        removeClusterNodes(1, CLUSTER_REMOVE_NODE1);
        ...
        startServer(0, 6999);
        deployStateless(0);
        addClusterNodes(0, CLUSTER_NODE1);
