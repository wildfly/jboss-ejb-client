...
/**
 * Client configuration which is configured through {@link Properties}. Some well known
 * properties will be looked for in the {@link Properties} that is passed to the {@link #LegacyPropertiesConfiguration(java.util.Properties) constructor},
...
public class LegacyPropertiesConfiguration {
    ...
    private Collection<RemotingConnectionConfiguration> remotingConnectionConfigurations = new ArrayList<>();
    ...
    public LegacyPropertiesConfiguration(final Properties properties) {
     ...
     * {@link LegacyPropertiesConfiguration} class. Else returns the {@link Thread#getContextClassLoader()}
     *
     * @return
     */
