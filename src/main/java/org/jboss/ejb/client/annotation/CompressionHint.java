...
/**
 * A hint to the Enterprise Beans client API that the data being communicated between the Enterprise Beans client and the server via the {@link org.jboss.ejb.client.EJBReceiver EJBReceiver(s)} should be compressed.
 * <p/>
...
public @interface CompressionHint {
    ...
    /**
     * True if the request data of an Enterprise Bean invocation should be compressed. False otherwise. By default this is <code>true</code>.
     */
    boolean compressRequest() default true;

    /**
     * True if the response data of an Enterprise Bean invocation should be compressed. False otherwise. By default this is <code>true</code>.
     */
