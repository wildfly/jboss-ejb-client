...
public final class EJBClient {
    ...
    public static void createSession(final Object proxy) {
        ...
        final EJBReceiver<?> ejbReceiver = EJBClientContext.requireCurrent().requireEJBReceiver(ejbInvocationHandler.getAppName(), ejbInvocationHandler.getModuleName(), ejbInvocationHandler.getDistinctName());
        try {
            final byte[] sessionId = ejbReceiver.openSession(ejbInvocationHandler.getAppName(), ejbInvocationHandler.getModuleName(), ejbInvocationHandler.getDistinctName(), ejbInvocationHandler.getBeanName());
