...
public final class EJBClient {
     ...
     *                                  {@link EJBClient#getProxy(String, String, String, Class, String)}
     */
     ...
     */
    public static <T> T getProxy(final String appName, final String moduleName, final String distinctName, final Class<T> viewType, final String beanName) throws IllegalArgumentException {
